<template>
  <div class="content">
    <div class="banner-box">
      <img
        class="banner-full"
        src="~/assets/images/banner-full.png"
        alt="banner"
      />
      <img
        class="banner-responsive"
        src="~/assets/images/banner-responsive.png"
        alt="banner"
      />
    </div>
    ...
    <div class="product-area">
      <div class="prd" v-for="(product, index) in products" :key="index">
            ...
            <div>
              ...
              <div v-if="product.available" class="product-price">
                ...
                <div class="member">
                  ...
                  <p class="price">
                    <span>{{ product.priceMember | toCurrency }}</span>
                  </p>
                </div>

                <p class="price-responsive">
                  Não sócio {{ product.priceStock | toCurrency }}
                </p>
              </div>
            </div>
        ...
        <div>
          <button
            v-if="product.available"
            class="btn btn-add-responsive f-1"
            @click="addToCart(product)"
          >
            Adicionar
          </button>
          <button v-else class="btn btn-non-available-responsive f-1">
            Esgotado
          </button>
        </div>
      </div>
